...
async def image_proxy(request: Request, url: str):
    parsed = urlparse(url)
    headers = {
        "Referer": "https://www.youtube.com/" if parsed.hostname and parsed.hostname.endswith(("youtube.com", "ytimg.com")) else "https://www.bilibili.com/",
        "User-Agent": request.headers.get("User-Agent", ""),
    }
    client_kwargs = {"timeout": 10.0}
    if parsed.hostname and parsed.hostname.endswith(("youtube.com", "ytimg.com")):
